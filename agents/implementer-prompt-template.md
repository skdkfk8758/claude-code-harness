...
Use this template when dispatching an implementer subagent per task.
...
Agent tool (general-purpose):
  ...
  prompt: |
    ...
    **Ask them now.** Raise any concerns before starting work.
    ...
    1. Write the failing test from the TDD steps (RED)
    ...
    **Testing:**
    - Do tests actually verify behavior (not just mock)?
    - Did I follow TDD?
